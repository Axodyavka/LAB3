...
function renderPagination(totalPages) {
    ...
    // РџРѕРєР°Р·С‹РІР°РµРј РІСЃРµ СЃС‚СЂР°РЅРёС†С‹, РµСЃР»Рё РёС… РјР°Р»Рѕ, РёР»Рё РѕРіСЂР°РЅРёС‡РµРЅРЅС‹Р№ РґРёР°РїР°Р·РѕРЅ
    let startPage = 1;
    let endPage = totalPages;

    // РћРіСЂР°РЅРёС‡РёРІР°РµРј РјР°РєСЃРёРјСѓРј 3 РІРёРґРёРјС‹С… СЃС‚СЂР°РЅРёС†С‹ РґР»СЏ РїСЂРѕСЃС‚РѕС‚С‹
    ...
    for (let i = startPage; i <= endPage; i++) {
        if (i > totalPages) break; // РџСЂРµРґРѕС‚РІСЂР°С‰Р°РµРј Р»РёС€РЅРёРµ РєРЅРѕРїРєРё
    ...
    fetch(`http://localhost:3000/products/${productId}`)
        ...
        .then(() => {
            updateHeader(true); // РћР±РЅРѕРІР»СЏРµРј С…РµРґРµСЂ (РєРѕСЂР·РёРЅСѓ)
        })
        .catch(error => {
            console.error('Error adding to cart:', error);
            // РќРµ РїРѕРєР°Р·С‹РІР°РµРј РјРѕРґР°Р»СЊРЅРѕРµ РѕРєРЅРѕ
        });
}
...
function deleteProduct(productId) {
    ...
    // РџСЂРѕРІРµСЂСЏРµРј, РµСЃС‚СЊ Р»Рё РїСЂРѕРґСѓРєС‚ РІ purchased Рё РµРіРѕ С‚РёРї
    Promise.all([
        ...
        .then(([purchasedItems, product]) => {
            ...
            // Р•СЃР»Рё РїСЂРѕРґСѓРєС‚ РјРѕР¶РЅРѕ СѓРґР°Р»РёС‚СЊ, РїРѕРєР°Р·С‹РІР°РµРј РїРѕРґС‚РІРµСЂР¶РґРµРЅРёРµ
    ...
    function setupEventListeners() {
        ...
        catalogCards.addEventListener('click', (e) => {
            ...
            if (addToCartBtn) {
                ...
                // РћС‚РєСЂС‹РІР°РµРј СЃС‚СЂР°РЅРёС†Сѓ С‚РѕРІР°СЂР°, РµСЃР»Рё РєР»РёРє РЅРµ РїРѕ РєРѕСЂР·РёРЅРµ/СѓРґР°Р»РµРЅРёСЋ
        ...
        // РЎР»СѓС€Р°С‚РµР»СЊ РґР»СЏ СЃРјРµРЅС‹ СЏР·С‹РєР°
