...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateAvailableDates() {
        ...
        availableDates = Array.from(dateInputs)
            ...
            .filter(date => date); // Р¤РёР»СЊС‚СЂСѓРµРј РїСѓСЃС‚С‹Рµ Р·РЅР°С‡РµРЅРёСЏ
    }
    ...
    function addDateField(date = '') {
        ...
        dateItem.innerHTML = `
            ...
            <button type="button" class="delete-date" data-i18n="product_page.labels.delete_date">${t.product_page.labels.delete_date || 'РЈРґР°Р»РёС‚СЊ РґР°С‚Сѓ'}</button>
        `;
