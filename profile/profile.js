...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // РџРѕР»СѓС‡РµРЅРёРµ РїРµСЂРµРІРѕРґРѕРІ
    const getCurrentTranslations = () => getTranslations(localStorage.getItem('language') || 'en');

    // РџРѕР»СѓС‡Р°РµРј С‚РµРєСѓС‰РµРіРѕ РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ РёР· localStorage
    const user = localStorage.getItem('currentUser');
    if (user) {
        currentUser = JSON.parse(user);
    } else {
        console.error('РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РЅРµ РЅР°Р№РґРµРЅ РІ localStorage');
        return;
    }

    // Р¤СѓРЅРєС†РёРё РІР°Р»РёРґР°С†РёРё
    ...
    const validateName = (name) => /^[A-Za-zРђ-РЇР°-СЏ]+$/.test(name);
    ...
    const validateForm = async () => {
        ...
        // Р’Р°Р»РёРґР°С†РёСЏ РґР°С‚С‹ СЂРѕР¶РґРµРЅРёСЏ
        ...
        // Р’Р°Р»РёРґР°С†РёСЏ РѕС‚С‡РµСЃС‚РІР°
        ...
        // Р’Р°Р»РёРґР°С†РёСЏ РЅРѕРјРµСЂР° РєР°СЂС‚С‹
        ...
        // Р’Р°Р»РёРґР°С†РёСЏ СЃСЂРѕРєР° РґРµР№СЃС‚РІРёСЏ РєР°СЂС‚С‹
        ...
        // Р’Р°Р»РёРґР°С†РёСЏ РёРјРµРЅРё РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ
    ...
    fetch(`http://localhost:3000/users?name=${encodeURIComponent(currentUser.userName)}`)
        ...
        .then(users => {
            if (users.length === 0) {
                console.error('РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ РЅРµ РЅР°Р№РґРµРЅ');
        ...
        .catch(error => {
            console.error('РћС€РёР±РєР° Р·Р°РіСЂСѓР·РєРё РґР°РЅРЅС‹С… РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ:', error);
            setError(form, 'profile_page.form.server_error');
        });
    ...
    // РћР±СЂР°Р±РѕС‚С‡РёРєРё РґР»СЏ РїР°СЂРѕР»СЏ
    ...
    // РћС‚СЃР»РµР¶РёРІР°РЅРёРµ РёР·РјРµРЅРµРЅРёР№ РІ РїРѕР»СЏС…
    ...
    // РћР±СЂР°Р±РѕС‚С‡РёРє РґР»СЏ РєРЅРѕРїРєРё "РЎРѕС…СЂР°РЅРёС‚СЊ"
    saveBtn.addEventListener('click', () => {
        if (!validateForm()) return;
        confirmModal.style.display = 'flex';
    });

    // РџРѕРґС‚РІРµСЂР¶РґРµРЅРёРµ РёР·РјРµРЅРµРЅРёР№
    ...
    // РћС‚РјРµРЅР° РёР·РјРµРЅРµРЅРёР№ РїСЂРё Р·Р°РєСЂС‹С‚РёРё РјРѕРґР°Р»СЊРЅРѕРіРѕ РѕРєРЅР°
    ...
    // РћР±РЅРѕРІР»РµРЅРёРµ РїРµСЂРµРІРѕРґРѕРІ РїСЂРё СЃРјРµРЅРµ СЏР·С‹РєР°
